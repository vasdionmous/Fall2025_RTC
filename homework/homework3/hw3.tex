...
\begin{exercise}{(\texttt{Εναλλαγή περιορισμού και επαγωγής})} \\
    ...
    \textcolor{lightgray}{\small{\emph{Υπόδειξη}: Υπολογίστε το εσωτερικό γινόμενο καθενός από τα δυο μέλη με έναν αυθαίρετο ανάγωγο χαρακτήρα της $G$ και χρησιμοποιήστε τον Νόμο Αντιστροφής του Frobenius (βλ. Θεώρημα 8.8).}}
\end{exercise}
